#userYC/models.py
#Se importa el modelo propio de AbstractUse y se extiende para agregar el campo phone
...
class UserYogaCenter(AbstractUser):
    phone = PhoneNumberField(blank=True, help_text='Contact phone number',region='VE')
